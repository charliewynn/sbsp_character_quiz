...
const options = {
    ...
    requestEvent : true,    // show the full request JSON sent to your code
    reprompt     : false,
...
var fs = require("fs");
var MyLambdaFunction = require('./custom/index.js'); // Your Lambda source with exports.handler

var MyDialog = './dialogs/default.txt';
var appId = 'amzn1.ask.skill.4f2782c5-5fc1-448f-af6c-58b3d27fd2b4'; // 'amzn1.ask.skill.d60ceb98-befe-4f49-a627-1f20f6e98d94';
